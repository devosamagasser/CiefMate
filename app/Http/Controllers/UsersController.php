...
class UsersController extends Controller
{
    ...
    private function updateWithAvatar($user, $request )
    {
        try{
            $data = $this->updatedDataFormated($request, $request->except('avatar'));
            $data['avatar'] = FileHandeler::updateFile($request->avatar, $user->avatar, 'avatars','jpg');
            return $data;
        } catch (\Exception $e) {
